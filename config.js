window.ECON_CONFIG = Object.freeze({
  calculationVersion: 'v2-offline-savings-draft-0.2',
  benchmarkVersion: 'pun-index-gme-2026-08-draft',
  currency: 'EUR',
  assumptions: {
    fallbackAllInCostPerKwh: 0.31,
    currentEnergyComponentShare: 0.75,
    avoidableRetailShare: 0.82,
    punReference: 0.198,
    targetSpreadLow: 0.010,
    targetSpreadHigh: 0.025,
    manualProcurementDeltaLow: 0.015,
    manualProcurementDeltaHigh: 0.040,
