...
# Idempotent because Netlify may already have applied part of this transform
# on the current production source before the one-shot materialization.
if "fetch('/api/track'" not in s:
    must(
